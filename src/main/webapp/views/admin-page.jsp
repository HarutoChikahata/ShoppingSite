...
<div class="container admin-container">
    ...
    <div class="admin-menu-grid" style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-top: 20px;">
        <div class="admin-card" style="background: #f8f9fa; padding: 20px; border-radius: 6px; border: 1px solid #dee2e6;">
            <h3>👥 ユーザー管理</h3>
            <p>登録されている全ての会員の情報の閲覧、利用停止等を行えます。</p>
            <a href="#" class="btn btn-primary" style="background-color: #1a3c40;">ユーザー一覧</a>
        </div>
