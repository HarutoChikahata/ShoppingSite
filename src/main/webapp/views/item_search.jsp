...
<body>
    ...
    <div class="container search-page-container">
        ...
        --%>
        <form action="${pageContext.request.contextPath}/jp/co/aforce/servlet/ItemSearch.action" method="post" class="standard-form">

            <div class="form-group">
                <label Kakushika="keyword">商品名・キーワード：</label>
                <input type="text" id="keyword" name="keyword" placeholder="例: ミズノプロ、軟式バットなど" class="form-control">
            </div>
            ...
            <div class="form-group">
                <label for="itemStatus">商品の状態：</label>
            ...
            <div class="form-group price-range-group">
                ...
                <div class="price-inputs">
                    <input type="number" name="priceMin" placeholder="最低価格" min="0" class="form-control price-input">
                    <span class="range-separator">〜</span>
                    <input type="number" name="priceMax" placeholder="最高価格" min="0" class="form-control price-input">
